...
const prependingTests = () =>
  describe('Prepending', () => {
    ...
    test('Prepends Single Value To Empty List', () => {
    ...
    test('Prepends Single Value To List', () => {
    ...
    test('Prepends Multiple Values To Empty List', () => {
    ...
    test('Prepends Multiple Values To List', () => {
