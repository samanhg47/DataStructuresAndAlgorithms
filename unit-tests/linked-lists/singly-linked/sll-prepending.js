...
const prependingTests = () =>
  describe('Prepending', () => {
    ...
    test('SLL: Prepends Single Value To Empty List', () => {
    ...
    test('SLL: Prepends Single Value To List', () => {
    ...
    test('SLL: Prepends Multiple Values To Empty List', () => {
    ...
    test('SLL: Prepends Multiple Values To List', () => {
