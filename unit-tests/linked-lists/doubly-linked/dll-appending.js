...
const appendingTests = () =>
  describe('Appending', () => {
    ...
    test('DLL: Appepends Single Value To Empty List', () => {
    ...
    test('DLL: Appepends Single Value To List', () => {
    ...
    test('DLL: Appepends Multiple Values To Empty List', () => {
    ...
    test('DLL: Appepends Multiple Values To List', () => {
